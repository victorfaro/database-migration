...
CREATE TABLE app.custom_columns (
	...
	column_type public."Custom Column Types" NULL,
	data_source public."Data Source" NULL,
	rerun_frequency public."Rerun Frequency" NULL,
	description text NULL,
	keyword_config jsonb NULL,
	output_format public."Output Format" NULL,
...
CREATE TABLE app.enrichments (
	...
	status public."Enrichment Status" NULL,
